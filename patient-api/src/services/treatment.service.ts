  ...
  async associateProductsWithTreatment(
    ...
    try {
      ...
      if (products.length > 0) {
        ...
        console.log(
          `✅ Created ${products.length} TreatmentProducts for treatment ${treatmentId}`
        );
        ...
        const totalProductsPrice = existingProducts.reduce(
      ...
      if (process.env.NODE_ENV === "development") {
        ...
        console.error("Error associating products with treatment");
      }
...
export type {
  TreatmentProductAssociationResult,
