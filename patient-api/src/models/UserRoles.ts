...
export default class UserRoles extends Entity {
     ...
     */
    getActiveRoles(): Array<'patient' | 'doctor' | 'admin' | 'brand'> {
        const roles: Array<'patient' | 'doctor' | 'admin' | 'brand'> = [];
     ...
     */
    hasRole(role: 'patient' | 'doctor' | 'admin' | 'brand'): boolean {
     ...
     */
    hasAnyRole(roles: Array<'patient' | 'doctor' | 'admin' | 'brand'>): boolean {
     ...
     */
    hasAllRoles(roles: Array<'patient' | 'doctor' | 'admin' | 'brand'>): boolean {
